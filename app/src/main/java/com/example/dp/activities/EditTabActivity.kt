...
class EditTabActivity : AppCompatActivity() {
    ...
    private fun updateTab(){
        ...
        dbHelper.updateTable(tab.id, updatedSong.songName, updatedSong.artist, updatedSong.songBody, capo, tuning, key, updatedSongChords.joinToString(" "), tab.minutes, tab.seconds)
